VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} FormArquivarResolver 
   Caption         =   "Horário da última interação"
   ClientHeight    =   4860
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4665
   OleObjectBlob   =   "FormArquivarResolver.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "FormArquivarResolver"
...
Private Sub btnCancel_Click()
    ...
    Projeto1.FormArquivarResolver.Hide
End Sub
