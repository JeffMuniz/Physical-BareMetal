VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} FormHorarioAtendimento 
   Caption         =   "Horário da última interação"
   ClientHeight    =   5595
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4680
   OleObjectBlob   =   "FormHorarioAtendimento.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "FormHorarioAtendimento"
...
Private Sub UserForm_Activate()
    ...
    If (SolicitacaoCliente = "S") Then
        optSolicitacaoClienteSim.value = "Verdadeiro"
        optSolicitacaoClienteSim.Enabled = False
        optSolicitacaoClienteNao.Enabled = False
    Else
        optSolicitacaoClienteSim.value = False
        optSolicitacaoClienteSim.Enabled = True
        optSolicitacaoClienteNao.Enabled = True
    End If
...
Private Sub btnCancel_Click()
    ...
    Projeto1.FormHorarioAtendimento.Hide
End Sub
